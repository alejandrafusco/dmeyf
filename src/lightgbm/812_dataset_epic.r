...
directory.root  <-  "C:\\Users\\Atix\\Documents\\Maestria\\DMEF"  #Google Cloud
...
"mforex_buy",
"tmobile_app",
"cmobile_app_trx" )   #aqui van las columnas que se quieren eliminar
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , payroll_mantenimiento         := mpayroll  / mcomisiones_mantenimiento ]
