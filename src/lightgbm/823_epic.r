...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:\\Users\\Atix\\Documents\\Maestria\\DMEF" },   #Windows
...
kBO_iter    <-  190   #cantidad de iteraciones de la Optimizacion Bayesiana
...
ksemilla_azar  <- 126323  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
